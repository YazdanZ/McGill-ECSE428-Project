        ...
        <div className='App-header'>
            ...
            <div className="title" style={{width: "70%", height:"10%", top:"-20px", left:"15%"}}>
                ...
                <div style={{ display: 'flex' }}>
                    ...
                    <select id ="select_pickup" name="select_pickup" value={selectedPickup} onChange={handlePickupChange}>
                    ...
                    <select id ="select_dropoff" value={selectedDropoff} onChange={handleDropoffChange}>
                        <option key={'------'} value={'------'}>------</option>
